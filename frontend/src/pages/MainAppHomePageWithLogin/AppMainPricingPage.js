...
import PricingMainBodyContainerComponent from "../../components/desktop/PricingMainBodyContainerComponent";

const AppMainPricingPage=() => {
            ...
            <>
                {(windowResizeCount >= 1000) ?
                    <div className={"main_scroll_body_component"} ref={mainScrollDivRef} onScroll={getScrollValue}>
                        ...
                        <PricingMainBodyContainerComponent/>
...
export default AppMainPricingPage;
