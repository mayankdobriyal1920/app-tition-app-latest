...
import {actionToGetAllNewStudentProfileDataList} from "../../../actions/CommonAction";
import DataTable from "react-data-table-component";

export default function NewStudentProfileComponent(){
    ...
    useEffectOnce(() =>{
        dispatch(actionToGetAllNewStudentProfileDataList());
