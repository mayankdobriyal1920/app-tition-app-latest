...
function StudentCreateProfileMobileComponentFunction(){
    ...
    return (
        <div className={"user_create_profile_main mobile_container"}>
            <div className={"user_create_profile_main_row"}>
                <div className={"personal_prof_form_2"}>
                    <div className={"profile_form_header"}>
                        Create your student profile
                    </div>
                    <form className={"mt-10"} onSubmit={submitCreateProfileForm}>
                       <div className={"profile_form_main_inner_body"}>
                        <div className="row">
...
export const StudentCreateProfileMobileComponent = React.memo(StudentCreateProfileMobileComponentFunction);
